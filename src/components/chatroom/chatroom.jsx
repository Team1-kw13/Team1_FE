...
export default function ChatRoom() {
  return (
    <div className="flex flex-col rounded-tl-[30px] rounded-tr-[30px] w-full fixed top-[90px] pt-[25px] relative"
      style={{ boxShadow: "0 4px 10px 0px rgba(0, 0, 0, 0.15)" }}>
      <div className="flex items-center justify-center">
        <div className="font-small font-light text-[13px] text-gray-400 mb-[27px]">AI가 생성한 응답입니다. 중요한 정보는 꼭 확인해주세요.</div>
      </div>
